...
describe "UserPages" do
	...
	describe "profile page" do
		let(:myUser) { FactoryGirl.create(:user) }
		let!(:m1) { FactoryGirl.create(:micropost, user: myUser, content: "Foo") }
		let!(:m2) { FactoryGirl.create(:micropost, user: myUser, content: "Bar") }
		
		before {visit user_path(myUser)}
		...
		describe "microposts" do
			...
			it { should have_content(m2.content) }	
		 	it { should have_content(myUser.microposts.count) }	
		end
		...
		describe "follow/unfollow buttons" do
			...
			describe "following a user" do
				...
				it "should increment the followed user count" do
					expect do
						click_button "Follow"
					end.to change(myUser.followed_users, :count).by(1)
				end
